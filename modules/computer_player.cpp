...
//
//
//    if(rememberFilledSquares[0] && rememberFilledSquares[4] && !rememberFilledSquares[8]){
//
//        b->markSquare(mark, 8);
//    }
...
//        b->markSquare(mark, 6);
//    }
//    else if(rememberFilledSquares[7] && rememberFilledSquares[4] && !rememberFilledSquares[2]){
//
//        b->markSquare(mark, 2);
//    }
//    else if(rememberFilledSquares[0] && rememberFilledSquares[1] && !rememberFilledSquares[2]){
//
//        b->markSquare(mark, 2);
//    }
//
